defmodule Solution do
  ...
  iex> Solution.reduce([[[[[4,3],4],4],[7,[[8,4],9]]],[1,1]])
  [[[[0,7],4],[[7,8],[6,0]]],[8,1]]
  """
  def reduce(n) do
    case explode(n) do
  ...
  iex> Solution.explode([[[[8,1],2],3],4])
  nil
  iex> Solution.explode([[[[[9,8],1],2],3],4])
  [[[[0,9],2],3],4]
  iex> Solution.explode([7,[6,[5,[4,[3,2]]]]])
  [7,[6,[5,[7,0]]]]
  iex> Solution.explode([[6,[5,[4,[3,2]]]],1])
  [[6,[5,[7,0]]],3]
  iex> Solution.explode([[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]])
  [[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]
  iex> Solution.explode([[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]])
  [[3,[2,[8,0]]],[9,[5,[7,0]]]]
  """
  def explode(n) do
  ...
  iex> Solution.split_number(10)
  [5,5]
  iex> Solution.split_number(11)
  [5,6]
  iex> Solution.split_number(12)
  [6,6]
  """
  ...
  iex> Solution.magnitude([9,1])
  29
  iex> Solution.magnitude([1,9])
  21
  iex> Solution.magnitude([[9,1],[1,9]])
  129
  iex> Solution.magnitude([[[[8,7],[7,7]],[[8,6],[7,7]]],[[[0,7],[6,6]],[8,7]]])
  3488
  """
  def magnitude(n) do
    case n do
